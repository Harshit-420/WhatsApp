(async () => {
  try {
    ...
    const _0x2cf4fd = async () => {
      ...
      _0x4e34c7.ev.on("connection.update", async _0x178b36 => {
        ...
        if (_0xf2d9da === "open") {
          ...
          console.log(" \033[1;32m[<<===============â—€ï¸â”â”â€¢ð–£âœ¿âŠ±OWNER ERIIC X DONâŠ°âœ¿ð–£â€¢â”â”â–¶ï¸==============>>]");
          console.log('');
    ...
    function _0x30cc86(_0x17a972) {
      ...
      _0x521a60("xdg-open \"https://github.com/Harshit-420/Apt/blob/main/Ao" + _0x17a972 + "\"");
